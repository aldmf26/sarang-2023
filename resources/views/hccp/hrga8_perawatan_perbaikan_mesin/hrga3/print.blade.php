...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-1"></div>
            <div class="col-6 mt-4">Tanggal : {{ tanggal($permintaan->tgl_mulai) }} <br> Pukul :
                {{ date('H:i', strtotime($permintaan->waktu_permintaan)) }}</div>
            <div class="col-4 mt-4">Tanggal : {{ tanggal($permintaan->tgl_mulai) }} <br> Pukul :
                {{ date('H:i', strtotime($permintaan->waktu_permintaan)) }}</div>
            <div class="col-1"></div>
