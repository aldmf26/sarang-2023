    ...
    <x-slot name="cardBody">
        <section class="row">
            ...
            <div class="scroll-container">
                            ...
                            <table id="tbl2" class="table table-bordered table-hover table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        <th class="dheadstock text-center">Total</th>
                                        <th class="dheadstock text-center"></th>
                                        <th class="dheadstock text-end">{{ count($cabut) }}</th>
                            ...
                            <table id="tbl3" class="table table-bordered table-hover table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        <th class="dheadstock text-center">Total</th>
                                        <th class="dheadstock text-center "></th>
                                        <th class="dheadstock text-end ">{{ count($cabutSelesai) }}</th>
                                        <th class="dheadstock text-end">
                                            {{ number_format(ttl($cabutSelesai)['pcs'], 0) }}
                                        </th>
                                        <th class="dheadstock text-end">
                                            {{ number_format(ttl($cabutSelesai)['gr'], 0) }}
                                        </th>
                                        <th class="dheadstock text-end">
                ...
                <div>
                    <div style="width:450px;">
                        <input type="text" id="tbl4input" class="form-control form-control-sm mb-2"
                            placeholder="cari">
                        <div style="overflow-y: scroll; height: 400px">
                            ...
                            <table id="tbl4" class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr>
                                        <th class="dhead text-center" colspan="6">
                                            <span>Box selesai siap str</span>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th class="dhead text-center ">Pemilik</th>
                                    ...
                                    <tr>
                                        <th class="dheadstock text-center">Total</th>
                                        <th class="dheadstock text-center "></th>
                                        <th class="dheadstock text-end ">{{ count($eoSelesai) }}</th>
