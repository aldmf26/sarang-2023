<x-theme.app title="{{ $title }}" table="Y" sizeCard="11">
    ...
    <x-slot name="cardBody">
        <section class="row">
            ...
            <div class="col-lg-12">
                <h5 for="" class="fw-bold text-decoration-underline">Box Stock</h5>
            ...
            <div class="col-lg-12">
                ...
                <h5 for="" class="fw-bold text-decoration-underline">Box Proses</h5>
                <table class="table table-bordered " id="bk_proses">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th class="dheadstock  text-end">{{ number_format(sumBk($box_proses, 'ttl_rp'), 0) }}</th>
                            <th class="dheadstock  text-end">
                                {{ number_format(sumBk($box_proses, 'ttl_rp') / sumBk($box_proses, 'gr'), 0) }}</th>
                        </tr>
                    </tfoot>
            ...
            <div class="col-lg-12">
                <hr style="border: 1px solid black">
                <h5 for="" class="fw-bold text-decoration-underline">Box selesai siap cetak</h5>
                <table class="table table-bordered " id="bk_selesai">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th class="dheadstock  text-end">
                                {{ number_format((sumBk($box_selesai, 'ttl_rp') + sumBk($box_selesai, 'cost_kerja')) / sumBk($box_selesai, 'gr'), 0) }}
                            </th>
                        </tr>
                    </tfoot>
