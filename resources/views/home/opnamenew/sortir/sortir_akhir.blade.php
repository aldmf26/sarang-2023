                ...
                <table class="table table-bordered " id="bk_stock">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th class="dheadstock "></th>
                            <th class="dheadstock "></th>
                            <th class="dheadstock  text-end">{{ number_format(sumBk($query, 'pcs') + $suntik->pcs, 0) }}</th>
                            <th class="dheadstock  text-end">{{ number_format(sumBk($query, 'gr') + $suntik->gr, 0) }}</th>
                            <th class="dheadstock  text-end">{{ number_format(sumBk($query, 'ttl_rp') + $suntik->ttl_rp, 0) }}</th>
