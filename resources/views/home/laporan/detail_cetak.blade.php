    ...
    <tbody>
        @foreach ($detail as $no => $d)
            <tr>
                ...
                <td class="text-end">{{ number_format($d->pcs_tdk_cetak, 0) }}</td>
                <td class="text-end">{{ number_format($d->gr_tdk_cetak, 0) }}</td>
                ...
                <td class="text-end">{{ number_format($d->bulan_dibayar, 0) }}</td>
            </tr>
        @endforeach
    </tbody>
</table>
