                    ...
                    <tbody>
                        @foreach ($partai as $no => $p)
                            <tr>
                                ...
                                <td class="text-end">
                                    {{ $p->hrga_satuan == 0 ? 0 : number_format(($p->cost_bk + $p->cost_cbt) / $p->gr_cbt, 0) }}
                                </td>
                                ...
                                <td class="text-end">
                                    {{ $p->hrga_satuan == 0 ? 0 : number_format(($p->cost_bk + $p->cost_cbt + $p->cost_ctk) / $p->gr_ctk, 0) }}
                                </td>
                                ...
                                <td class="text-end">
                                    {{ $p->hrga_satuan == 0 ? 0 : number_format(($p->cost_bk + $p->cost_cbt + $p->cost_ctk + $p->cost_str) / $p->gr_str, 0) }}
                                </td>
