                        ...
                        <thead class="bg-white">
                            <tr>
                                ...
                                @php
                                    ...
                                    $rp_gr = $ttlGr == 0 ? 0 : $ttlRp / $ttlGr;
                                    $rp_gr_bk = $ttlGr == 0 ? 0 : $cost_bk / $ttlGr;
                                    $rp_gr_kerja = $ttlGr == 0 ? 0 : $cost_kerja / $ttlGr;
                                    $rp_gr_cu = $ttlGr == 0 ? 0 : $cost_cu / $ttlGr;
                                @endphp
                                <th class="text-end">
                                    <h6>
                        ...
                        <tbody>
                            @foreach ($getFormulir as $d)
                                ...
                                <tr class="pointer">
                                    ...
                                    @role('presiden')
                                        <td align="right">{{ number_format($d->gr_awal == 0 ? 0 : $d->total_rp / $d->gr_awal, 0) }}</td>
