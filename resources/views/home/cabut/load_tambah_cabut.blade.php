                        ...
                        <tr class="baris{{ $i + 1 }}">
                            ...
                            <td>
                                <input type="date" value="{{ date('Y-m-d') }}" class="form-control"
                                    name="tgl_terima[]">
                                <input type="hidden" value="{{ $x->id_cabut }}" class="form-control"
                                    name="id_cabut[]">
                            </td>
                            <td>
                                <select name="no_box[]" id="" class="select3 pilihBox"
                                    count="{{ $i + 1 }}">
                                    <option value="">Pilih Box</option>
                                    @foreach ($boxBk as $d)
                                        @if ($d->gr_awal - $d->gr_cabut > 1)
                                            <option @selected($d->no_box == $box->no_box) value="{{ $d->no_box }}">
                                                {{ ucwords($d->no_box) }}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </td>
                            ...
                            <td>
                                ...
                                <select name="id_paket[]" id=""
                                    class="select3 pilihAnak pilihAnak{{ $i + 1 }}"
                                    count="{{ $i + 1 }}">
                                    <option value="">Pilih</option>
                                </select>
                            </td>
                            ...
                            <td>
                                <input readonly type="text"
                                    class="form-control rupiahInput text-end setRupiah{{ $i + 1 }}"
                                    value="0">
                                <input readonly type="hidden"
                                    class="form-control rupiahInput text-end rupiahBiasa{{ $i + 1 }}"
                                    value="0" name="rupiah[]">
                            </td>
                            <td align="center">
