                ...
                <table style="border:1px solid #97a1c3" class="table table-bordered" id="tblAld"
                    ...
                    <tbody>
                        ...
                        sum((1 - (a.gr_flx + a.gr_akhir) / a.gr_awal) * 100) as susut
                                            ...
                                            WHERE  a.id_pengawas = '$id' AND a.no_box != 9999 AND a.bulan_dibayar = '$bulan' AND tahun_dibayar = '$tahun'
                                            GROUP by a.no_box;");
                            @endphp
                            @foreach ($query as $x)
                    <tbody x-show="openRows.includes({{ $i }})">
                        ...
                        <tr>
                            ...
                            <td align="right"><a class="detail" target="_blank"
                                    href="{{ route('dashboard.detail', ['cabut',$x->no_box]) }}">{{ number_format($x->no_box, 0) }}
