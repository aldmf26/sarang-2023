    ...
    <tbody>
        @foreach ($cetak as $no => $c)
            <tr data-id="{{ $c->id_cetak }}">
                ...
                <td align="center">
                    @if (empty($c->capai))
                        <button class="btn btn-sm btn-success capai no{{$c->id_cetak}}" id_cetak="{{ $c->id_cetak }}" capaiVal="Y"><i
                                class="fas fa-check"></i></button>
                        <button class="btn btn-sm btn-danger capai no{{$c->id_cetak}}" id_cetak="{{ $c->id_cetak }}" capaiVal="T">
