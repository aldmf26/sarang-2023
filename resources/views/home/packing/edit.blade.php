<x-theme.app title="{{ $title }}" table="Y" sizeCard="12" cont="container-fluid">
    ...
    <x-slot name="cardBody">
        ...
        <form action="{{ route('packinglist.update') }}" method="post">
            @csrf
            <section class="row">
                <div class="col-lg-12">
                    <table class="table table-stripped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input count="{{ $i }}" value="{{ $d->pcs_akhir }}" type="text" required name="pcs_akhir[]" class="form-control selectAll pcs">
                                </td>
                                <td>
                                    <input count="{{ $i }}" value="{{ $d->gr_akhir }}" type="text" required name="gr_akhir[]" class="form-control selectAll gr">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input count="{{$i}}" value="{{ $d->ket }}" type="text" name="ket[]" class="form-control selectAll ket">
                                </td>
                            </tr>
                            @endforeach
