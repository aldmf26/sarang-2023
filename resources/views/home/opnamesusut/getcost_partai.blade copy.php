            ...
            <tbody>
                ...
                <tr>
                    <td><a href="#" class="detail_cabut fw-bold" nm_partai="{{ $bk->nm_partai }}"
                            data-bs-toggle="modal" data-bs-target="#detail_cabut_tes">Cabut {{ $cabut->gr_awal }} -
                            {{ $eo->gr_eo_awal }}</a></td>
                    <td></td>

                    <td class="text-end">{{ number_format($cabut->pcs ?? 0, 0) }}</td>
                    <td class="text-end">{{ number_format($grAwalCabut, 0) }}</td>
                    <td class="text-end">{{ number_format($cabut->pcs ?? 0, 0) }}</td>
                    <td class="text-end">{{ number_format($grAkhirCabut, 0) }}</td>
                    <td class="text-end">
                        {{ number_format((1 - $grAkhirCabut / $grAwalCabut) * 100, 0) }}%
                    </td>
                    <td class="text-end">{{ number_format($cabutModal, 0) }}</td>
                    <td class="text-end">{{ number_format(($cabut->ttl_rp ?? 0) + ($eo->ttl_rp ?? 0), 0) }}</td>
                    <td class="text-end">0</td>
                    <td class="text-end">
                        {{ number_format($$modalCabutTbhCost, 0) }}
                    </td>
                    <td class="text-end">
                        {{ $grAkhirCabut == 0 ? 0 : number_format($$modalCabutTbhCost / $grAkhirCabut, 0) }}
                    </td>
                    ...
                    <td class="text-end">
                        {{ number_format($cabutModal + ($bk->ttl_rp - ($cabut->modal_rp ?? 0) - ($eo->modal_rp ?? 0)), 0) }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-end">
                        {{ number_format($grAkhirCabut - $cetak->gr_awal, 0) }}
                    </td>
                    <td class="text-end">
                        {{ number_format($$modalCabutTbhCost - ($cetak->modal_rp + $cetak->cost_kerja), 0) }}
                    </td>
                    <td class="text-end">
                        {{ $grAkhirCabut - $cetak->gr_awal == 0 ? 0 : number_format(($$modalCabutTbhCost - ($cetak->modal_rp + $cetak->cost_kerja)) / ($grAkhirCabut - $cetak->gr_awal), 0) }}
                    </td>
                    <td class="text-end">
                        {{ number_format($$modalCabutTbhCost - ($cetak->modal_rp + $cetak->cost_kerja) + ($cetak->modal_rp + $cetak->cost_kerja), 0) }}
                    </td>
                </tr>
                <tr>
