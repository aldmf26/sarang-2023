        ...
        @foreach ($datas as $no => $d)
            <tr>
                ...
                <td>
                    ...
                    <x-theme.button modal="Y" idModal="delete" data="no_nota={{ $d->id_kelas }}_{{$routeRemove}}" icon="fa-trash"
                        addClass="float-end delete_nota" teks="" variant="danger" />
                    <x-theme.button modal="Y" idModal="edit{{$d->id_kelas}}" icon="fa-pen" addClass="me-1 float-end edit-btn"
                        teks="" data="id_kelas={{ $d->id_kelas }}" />
                </td>
            </tr>
        @endforeach
    </tbody>
