<x-theme.app title="{{ $title }}" table="Y" sizeCard="12">
    ...
    <x-slot name="cardBody">
        ...
        <section class="row">
            <div class="col-lg-8">
                <form action="{{ route('kelas.spesialCreate') }}" method="post">
                    ...
                    <table class="table" id="tblScroll" x-data="{
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-end dhead">Pcs xbayar</th>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-info">
                                <td></td>
                                <td>
                                    <select x-model="selectedOption" x-init="initSelect2()" database="paket"
                                ...
                                <td>
                                    <select x-model="selectedOption" x-init="initSelect2()" database="tipe"
                                        class="select2-alpine tipe" name="id_tipe_brg_tambah[]" id="">
                            ...
                            <template x-for="(row, index) in rows" :key="index">
                                <tr class="bg-info">
                                    ...
                                    <td>
                                        <select x-model="selectedOption" database="tipe" x-init="initSelect2()"
                            ...
                            @foreach ($datas as $no => $d)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input x-mask:dynamic=" $money($input)" value="{{ $d->pcs_xbayar }}"
                                            class="form-control text-end" name="pcs_xbayar[]">
                                    </td>
