        ...
        $cabutGroup = DB::select("SELECT 
                        ...
                        LEFT JOIN (
                            SELECT 
                                ...
                                FROM sortir WHERE no_box != 9999 AND penutup = 'T' AND bulan = '$bulan' AND YEAR(tgl_input) = '$tahun' GROUP BY id_pengawas
                        ...
                        LEFT JOIN (
                            ...
                            JOIN (
                                SELECT no_box,id_pengawas FROM sortir where bulan = '$bulan' AND YEAR(tgl_input) = '$tahun' GROUP BY no_box,id_pengawas
                        ...
                        LEFT JOIN (
                            ...
                            FROM sortir WHERE no_box != 9999 AND penutup = 'T' AND bulan = '$bulan' AND YEAR(tgl_input) = '$tahun'
                            GROUP BY id_pengawas
                        ) as e ON e.id_pengawas = a.id_pengawas
                        WHERE  a.no_box != 9999 AND a.penutup = 'T' AND a.bulan = '$bulan' AND YEAR(a.tgl_input) = '$tahun'
