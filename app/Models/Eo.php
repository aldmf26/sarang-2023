...
class Eo extends Model
{
    ...
    public static function queryRekapGroup($bulan, $tahun)
    {
        ...
        LEFT JOIN (
            select id_pengawas,sum(gr_eo_awal) as gr_awal, sum(gr_eo_akhir) as gr_akhir, sum(ttl_rp) as ttl_rp from eo where no_box != 9999 and penutup = 'T' GROUP BY id_pengawas
        ...
        LEFT JOIN (
            ...
            JOIN (
                SELECT no_box FROM eo GROUP BY no_box
        ...
        LEFT JOIN (
            ...
            FROM eo WHERE no_box != 9999 AND penutup = 'T'
