...
class CetakModel extends Model
{
    ...
    public static function getCetakQuery($id_anak = 'All', $tgl1, $tgl2, $id_pengawas, $hal)
    {
        ...
        if ($id_anak == 'All') {
            ...
            where a.tgl between '$tgl1' and '$tgl2' and a.penutup = 'T' and f.no_box is null $pgws $halaman 
            ...
            left join kelas_cetak as e on e.id_kelas_cetak = a.id_kelas_cetak
            left join formulir_sarang as f on f.no_box = a.no_box and f.kategori = 'sortir'
            where a.tgl between '$tgl1' and '$tgl2' and a.penutup = 'T' and f.no_box is null and a.id_anak = '$id_anak' $pgws $halaman  
            order by a.tgl DESC, b.nama ASC
            ;");
        }
        return $cetak;
    ...
    public static function gaji_global($bulan_dibayar, $tahun_dibayar, $id_pengawas)
    {
        ...
        left join (
            ...
            FROM cabut as d 
            where d.bulan_dibayar = '$bulan_dibayar' and d.no_box != '9999' and d.selesai = 'Y'
            GROUP by d.id_anak
        ...
        left join (
            ...
            FROM sortir as e 
            where e.bulan = '$bulan_dibayar' and e.tahun_dibayar = '$tahun_dibayar' and e. no_box != '9999' and e.selesai = 'Y'
            group by e.id_anak
        ...
        left join uang_makan as j on j.id_uang_makan = a.id_uang_makan
