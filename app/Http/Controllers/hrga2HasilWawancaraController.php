...
class hrga2HasilWawancaraController extends Controller
{
    ...
    public function index(Request $r)
    {
        ...
        return view('hccp.hrga1_penerimaan.hrga2.index', $data);
    }
    public function getData()
    {
        ...
        return view('hccp.hrga1_penerimaan.hrga2.getdata', $data);
    }
    public function create(Request $r)
    {
        ...
        return view('hccp.hrga1_penerimaan.hrga2.tambah', $data);
    }
    ...
    public function berhasil(Request $r)
    {
        ...
        return view('hccp.hrga1_penerimaan.hrga2.berhasil', $data);
    }
...
- Ybs Tidak neko-neko, Terlihat teliti dan tidak mudah bosan",
    ...
    public function edit($id)
    {
        ...
        return view('hccp.hrga1_penerimaan.hrga2.edit', $data);
    }
