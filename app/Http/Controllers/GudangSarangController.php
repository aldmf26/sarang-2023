...
class GudangSarangController extends Controller
{
    ...
    public function print_formulir_grade(Request $r)
    {
        $formulir = DB::table('formulir_sarang as a')
            ...
            .tipe,a
            .no_box, 
            sum(a.pcs_awal) as pcs, sum(a.gr_awal) as gr, sum(c.pcs_awal) as pcs_srt, sum(c.gr_awal) as gr_srt, 
            sum(c.pcs_tdk_sortir) as pcs_tdk_sortir, sum(c.gr_tdk_sortir) as gr_tdk_sortir')
            ->get();
    ...
    public function print_po_wip2(Request $r)
    {
        ...
        left join qc as c on c.box_pengiriman = a.no_box and c.no_invoice = a.no_invoice
