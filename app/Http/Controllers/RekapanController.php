...
class RekapanController extends Controller
{
    ...
    public function index(Request $r)
    {
        ...
        e.d_cetak, f.rp_spesial, g.rp_eo, h.rp_sortir,i.rp_dll
                FROM tb_anak as a 
                left join users as b on b.id = a.id_pengawas
                left join (
                    SELECT c.id_anak , sum(c.nilai) as absen
                    FROM absen as c 
                    where c.tgl between '2023-09-01' and '2023-09-14'
                    group by c.id_anak
                ...
                left join (
                    ...
                    FROM cabut as d 
                    where d.tgl_terima BETWEEN '2023-09-01' and '2023-09-14' AND d.selesai = 'Y'
                    group by d.id_anak
                ...
                LEFT JOIN (
                    ...
                    FROM cetak AS e 
                    WHERE e.tgl BETWEEN '2023-09-01' AND '2023-09-14' AND e.selesai = 'Y'
                    GROUP BY e.id_anak
                  ) AS e ON e.id_anak = a.id_anak
                  
                  LEFT JOIN (
                      SELECT f.id_anak , SUM(f.ttl_rp) AS rp_spesial
                    FROM cabut_spesial AS f 
                    WHERE f.tgl BETWEEN '2023-09-01' AND '2023-09-14' AND f.selesai = 'Y'
                    GROUP BY f.id_anak
                  ) AS f ON f.id_anak = a.id_anak
                  
                  LEFT JOIN (
                      SELECT g.id_anak , SUM(g.ttl_rp) AS rp_eo
                      FROM eo AS g 
                      WHERE g.tgl_ambil BETWEEN '2023-09-01' AND '2023-09-14' AND g.selesai = 'Y'
                    GROUP BY g.id_anak
                  ...
                  LEFT JOIN (
                      ...
                      FROM sortir AS h
                      WHERE h.tgl BETWEEN '2023-09-01' AND '2023-09-14' AND h.selesai = 'Y'
                    GROUP BY h.id_anak
                  ...
                  LEFT JOIN (
                      ...
                      WHERE i.tgl BETWEEN '2023-09-01' AND '2023-09-14'
                    GROUP BY i.id_anak
                  ) AS i ON i.id_anak = a.id_anak
                
                where a.id_pengawas = 15;");
