...
ORDER BY g.grade DESC;");
    ...
    {
        $data = DB::select("SELECT a.nm_partai, a.no_box as kode_lot, a.pcs_awal, a.gr_awal FROM bk as a where a.tgl_input between '$r->tgl1' and '$r->tgl2' and a.kategori = 'cabut'
